...
namespace LiveTilesV3.Controllers
{
    ...
    {
        private CalenderDbContext db = new CalenderDbContext();
        ...
        public ActionResult Create([Bind(Include = "CalenderId,Title,Contents,Location,StartTime,EndTime")] Calender calender)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CalenderId,Title,Contents,Location,StartTime,EndTime")] Calender calender)
        {
            if (ModelState.IsValid)
            {
